...
CREATE TABLE meteorologia (
    meteorologia_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    morro_id VARCHAR2(36) NOT NULL,
    temperatura FLOAT NOT NULL,
    umidade FLOAT NOT NULL,
    descricao VARCHAR2(255),
    chovendo NUMBER(1) DEFAULT 0, -- 0 = Não está chovendo, 1 = Está chovendo
    data_hora TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_meteorologia_morro FOREIGN KEY (morro_id) REFERENCES morros(morro_id)
);